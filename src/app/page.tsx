...
import { KAKAO_LINK } from "@/constants";
      ...
      <main className="flex flex-col items-center justify-center flex-grow w-full">
        ...
        <section className="text-center py-16 w-full">
          ...
          <div className="mt-8">
            ...
            <a target="_blank" href={KAKAO_LINK} className="bg-gray-800 text-white px-6 py-2 rounded-full text-lg font-semibold">직접 문의하기</a>
          </div>
        </section>
        <section className="text-center w-full py-16 bg-gray-light">
